...
const FeaturesSection = () => {
    return (
        <div className="lg:px-[60px] px-4 py-[100px]">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:gap-0 gap-8 text-center md:text-left">
                ...
                <div className="group flex text-[#303030] lg:border-r  border-[#303030]/25 gap-8 items-center md:items-start lg:pe-[75px]">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold mb-1.5  text-start">Worldwide Shipping</h3>
                        <p className="text-base opacity-[75%] text-start">Doesn’t matter wherever you are, you will always get your order.</p>
                    </div>
                </div>
                ...
                <div className="group flex text-[#303030] lg:border-r  border-[#303030]/25 gap-8 items-center md:items-start lg:px-[75px]">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold mb-1.5 text-start">Fast Delivery</h3>
                        <p className="text-base opacity-[75%] text-start">Get your orders delivered quickly and efficiently with our fast delivery service</p>
                    </div>
                </div>
                ...
                <div className="group flex text-[#303030]  gap-8 items-center md:items-start lg:ps-[75px]">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold mb-1.5 text-start">Secure Transaction    </h3>
                        <p className="text-base opacity-[75%] text-start">We are a verified marketplace
